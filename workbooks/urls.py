...
urlpatterns = [
    ...
    path('previous_review/', views.WorkbookPreviousReviewView.as_view(), name='previous_review'),
    ...
    path('<str:workbook_id>/archive/', views.WorkbookArchiveView.as_view(), name='archive'),
    path('<str:workbook_id>/questions/new/', views.QuestionCreateView.as_view(), name='question_new'),
    path('<str:workbook_id>/questions/new_bulk/', views.QuestionBulkCreateView.as_view(), name='question_bulk_new'),
    ...
    path('<str:workbook_id>/trainings/exam', views.WorkbookExamView.as_view(), name='training_exam'),
